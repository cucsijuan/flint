...
> **Status:** early development. Vaults, the live-preview editor, wikilinks, search, tags and the command palette work; see the [roadmap](ROADMAP.md) for what comes next.
